...
IdDeRepositorio = URIRef("id_de_repositorio", my_ns)
id_de_repositorio_tiene_catalogo = URIRef("id_de_repositorio_tiene_catalogo", my_ns)
id_de_repositorio_tiene_repositorio = URIRef("id_de_repositorio_tiene_repositorio", my_ns)
id_de_repositorio_tiene_literal = URIRef("id_de_repositorio_tiene_literal", my_ns)
CatalogoDeRepositorios = URIRef("catalogo_de_repositorios", my_ns)
PalabraClave = URIRef("palabra_clave", my_ns)
...
Software = URIRef("software", my_ns)
Certificacion = URIRef("certificacion", my_ns)
repositorio_asociado_a_software = URIRef('repositorio_asociado_a_software', my_ns)
...
tiene_sinonimo_palabra_clave = URIRef('tiene_sinonimo_palabra_clave', my_ns)
tiene_palabra_clave_repositorio = URIRef('tiene_palabra_clave_repositorio', my_ns)
...
RedSocial = URIRef('red_social', my_ns)
...
tiene_nombre_licencia = URIRef('tiene_nombre_licencia', my_ns)
tiene_url_licencia = URIRef('tiene_url_licencia', my_ns)
repositorio_relacionado_con_licencia = URIRef('repositorio_relacionado_con_licencia', my_ns)
repositorio_permite_licencia = URIRef('repositorio_permite_licencia', my_ns)

repositorio_esta_activo = URIRef('repositorio_esta_activo', my_ns)
...
FormatoDeArchivo = URIRef('formato_de_archivo', my_ns)
FormatoDeArchivoAbierto = URIRef('formato_de_archivo_abierto', my_ns)
