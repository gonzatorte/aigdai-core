    ...
    with open(data_path, 'r') as file:
        ...
        for (idx, registry) in enumerate(registries):
            ...
            if only_org_ids is not None and idd_w_schema not in only_org_ids and not more_ids_formatted.intersection(only_org_ids):
                continue
            organizacion = rdf_types.Organizacion.child_uri_ref(idd_w_schema)
            ...
            for location_alfa2 in countries:
                ...
                location = rdf_types.Pais.child_uri_ref(location_alfa3)
            ...
            for other_org_id_raw in children:
                ...
                other_org = rdf_types.Organizacion.child_uri_ref(other_org_id)
